...
M.open = function()
  require("dotnet-cli.ui").open(M.commands, { title = "Dotnet Manager" })
end
...
---@param opts? DotnetCliOpts
M.setup = function(opts)
  opts = vim.tbl_deep_extend("force", { roslyn_auto_insert = true }, opts or {})
  ...
  if opts.roslyn_auto_insert then
